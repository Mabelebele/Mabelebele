...
A complete backend solution for a mobile car wash application built with Spring Boot, Java 17, and PostgreSQL.

> **🚀 Quick Links:**
> - **[COMPLETE SETUP GUIDE](COMPLETE_GUIDE.md)** - Start here for full instructions
> - **[QUICK START](QUICK_START.md)** - Get running in 5 minutes
> - **Swagger API Docs**: http://localhost:8080/api/swagger-ui.html (after starting app)

## 🎯 What You Get

A **production-ready backend** with 50+ Java files including:

- ✅ Complete REST API with JWT authentication
- ✅ User, Vehicle, Service, Booking, and Payment management
...
**Using IntelliJ:**
- Open project → Run `MobileCarWashApplication.java`
...
- **Import Postman Collection**: `Mobile_Car_Wash_API.postman_collection.json`
